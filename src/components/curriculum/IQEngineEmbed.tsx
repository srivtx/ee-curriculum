...
export function IQEngineEmbed({
  ...
  return (
    <div className="overflow-hidden rounded-sm border border-warning/30 bg-background">
      <div className="flex items-center gap-2 border-b border-border/60 bg-warning/8 px-3 py-2">
        ...
        <a
          ...
          className="ml-auto inline-flex items-center gap-1 rounded px-2 py-0.5 text-[10px] font-medium text-warning hover:bg-warning/10"
        >
