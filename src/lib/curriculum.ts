    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'p1m1l1', title: 'The five quantities and their units', type: 'reading', duration_min: 45, summary: 'Q (C), I (A=C/s), V (V=J/C), P (W=J/s=VA), W (J=Ws). The entire vocabulary of circuit analysis.', key_takeaways: ['Memorize units cold: C, A, V, W, J', 'Power is the rate of energy delivery', 'Energy is the integral of power over time'] },
      ...
      },
      {
        ...
        lessons: [
          { id: 'p1m2l1', title: 'Ohm’s law: the constitutive relation of a resistor', type: 'reading', duration_min: 45, summary: 'V=IR. Linear, time-invariant, memoryless. Real resistors have tempco (~100 ppm/°C), parasitic L (~nH), parasitic C to ground. Negligible at DC; matters at RF.', key_takeaways: ['V=IR is the constitutive law, not a derived theorem', 'Linear, time-invariant, memoryless', 'Real resistors deviate at high frequency'] },
  ...
  // ════════════════════════════════════════════════════════════════════
  {
    ...
    modules: [
      ...
      },
      {
        ...
        duration_hours: 6, difficulty: 'Foundation',
        lessons: [
          { id: 'p2m2l1', title: 'The three impedances', type: 'reading', duration_min: 60, summary: 'Z_R=R (real), Z_L=jωL (imaginary positive — V leads I by 90°), Z_C=1/(jωC) (imaginary negative — I leads V by 90°).', key_takeaways: ['Resistor: V and I in phase', 'Inductor: V leads I by 90°', 'Capacitor: I leads V by 90°'] },
      ...
      },
      {
        ...
        duration_hours: 7, difficulty: 'Intermediate',
        lessons: [
          { id: 'p2m4l1', title: 'Series and parallel resonance', type: 'reading', duration_min: 60, summary: 'At ω_0=1/√(LC), L and C cancel. Series: Z=R (minimum, max current). Parallel: Z=R (maximum, min current). Q=ω_0/BW measures sharpness.', key_takeaways: ['ω_0=1/√(LC) is the resonant frequency', 'Series resonance: Z minimum, current maximum', 'Parallel resonance: Z maximum, current minimum', 'Q=ω_0/BW; high Q = sharp resonance'] },
          { id: 'p2m4l2', title: 'Bode plots: magnitude in dB, phase in degrees', type: 'reading', duration_min: 75, summary: 'dB=20·log|H|. Each pole: −20dB/decade, −45° at pole, −90° a decade above. Each zero: +20dB/decade, +90°. Second-order: twice the slope.', key_takeaways: ['dB=20·log|H| (voltage); 10·log|H|² (power)', 'Pole: −20dB/decade, phase −90° asymptote', 'Zero: +20dB/decade, phase +90° asymptote', '−3dB = half power point'], has_playground: true },
        ],
        projects: [
    ...
    modules: [
      ...
      { id: 'p4m3', title: 'Sequential Logic: Flip-Flops, Counters, Registers', description: 'D, T, JK, SR flops. Setup/hold/metastability. Ripple vs synchronous counters. Shift registers.',
        ...
        lessons: [
          ...
          { id: 'p4m3l3', title: 'Counters and shift registers', type: 'reading', duration_min: 60, summary: 'Ripple counter: slow (count ripples through n flops). Synchronous: fast (all share clock, combinational computes next count). Ring counter: 1 circulates. Johnson: 2n states from n flops. Shift register: basis of serial comms.', key_takeaways: ['Synchronous counters are faster than ripple', 'Johnson counter: 2n states from n flops', 'Shift registers = UART, SPI, I2C basis'] },
        ],
        projects: [
      ...
      { id: 'p4m8', title: 'Communication: UART, SPI, I2C, CAN', description: 'UART (point-to-point, 9600-3Mbaud). SPI (bus with CS, 1-50 MHz). I2C (addressed, 100kHz-3.4MHz). CAN (automotive, differential, 1 Mbit/s).',
        ...
        lessons: [
          { id: 'p4m8l1', title: 'Four protocols compared', type: 'reading', duration_min: 75, summary: 'UART: 2 wires (TX/RX), point-to-point, 9600-3Mbaud, debug serial. SPI: 4 wires (MOSI/MISO/SCK/CS), bus with CS per slave, 1-50 MHz, fast ADCs. I2C: 2 wires (SDA/SCL), multi-drop addressed, 100kHz-3.4MHz, sensors. CAN: 2 wires (H/L), differential, 1 Mbit/s, automotive.', key_takeaways: ['UART = point-to-point, simplest', 'SPI = fast, but CS per slave', 'I2C = addressed, only 2 wires', 'CAN = robust, differential, multi-master'] },
  ...
  // Phase 5-10 — condensed (the full content lives in the PDF; the website shows summaries)
  {
    ...
    modules: [
      ...
      { id: 'p5m4', title: 'Laplace Transform and the s-Domain', description: 'Generalizes Fourier with complex s=σ+jω. Differentiation → multiplication by s. Poles in LHP = stable.',
        duration_hours: 9, difficulty: 'Intermediate',
        lessons: [
          { id: 'p5m4l1', title: 'Laplace transform and pole/zero analysis', type: 'reading', duration_min: 90, summary: 'X(s)=∫x(t)·e^(−st)dt. Poles of H(s)=N(s)/D(s) are roots of D. LHP poles = stable. jω axis = sustained oscillation. RHP = unstable.', key_takeaways: ['Laplace handles signals Fourier cannot (growing exponentials)', 'Pole locations determine stability', 'Fourier is Laplace evaluated on jω axis'], has_playground: true },
        ],
        projects: [
  ...
  // Phase 6-10 — summary only (full content in PDF)
  {
    ...
    modules: [
      { id: 'p6m1', title: 'Feedback, Modeling, Transfer Functions', description: 'Plant P(s), sensor H(s), controller C(s). T(s)=CP/(1+CPH). Characteristic equation 1+L(s)=0.',
        duration_hours: 6, difficulty: 'Intermediate',
        lessons: [{ id: 'p6m1l1', title: 'Feedback loop analysis', type: 'reading', duration_min: 75, summary: 'T(s)=CP/(1+CPH). Loop gain L=CPH. Characteristic equation 1+L=0; roots are closed-loop poles. Stability requires all in LHP.', key_takeaways: ['Closed-loop TF: T=CP/(1+CPH)', 'Characteristic equation 1+L=0 sets stability', 'Same math for circuits, mechanical, thermal, fluid systems'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p6m2', title: 'Stability: Routh-Hurwitz', description: 'Number of RHP poles from Routh array first-column sign changes. No need to solve for poles.',
        duration_hours: 6, difficulty: 'Intermediate',
        lessons: [{ id: 'p6m2l1', title: 'Routh-Hurwitz criterion', type: 'reading', duration_min: 75, summary: 'Build Routh array from polynomial coefficients. Sign changes in first column = RHP poles. Zero sign changes = stable.', key_takeaways: ['Routh array: first column sign changes count RHP poles', 'Works for any order polynomial', 'Verify with numpy.roots'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p6m3', title: 'Time-Domain Response and Steady-State Error', description: 't_r, t_p, %OS, t_s. System type (number of integrators). Step/ramp/parabola error constants.',
        duration_hours: 6, difficulty: 'Intermediate',
        lessons: [{ id: 'p6m3l1', title: 'Step response metrics and steady-state error', type: 'reading', duration_min: 75, summary: 't_r≈1.8/ω_n, %OS=e^(−πζ/√(1−ζ²))·100, t_s≈4/(ζω_n). System type N (poles at origin). Type 0: finite step error; Type 1: zero step, finite ramp; Type 2: zero step+ramp, finite parabola.', key_takeaways: ['ζ and ω_n determine transient shape', 'Adding integrator increases type, reduces error, reduces stability', 'Trade-off between accuracy and stability is fundamental'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p6m4', title: 'Root Locus Design', description: 'How closed-loop poles move as K varies from 0 to ∞. Starts at OL poles, ends at OL zeros. Asymptotes, breakaway points.',
        duration_hours: 8, difficulty: 'Intermediate',
        lessons: [{ id: 'p6m4l1', title: 'Root locus rules and design', type: 'reading', duration_min: 90, summary: 'Real-axis segments left of odd # of OL poles/zeros. Asymptote angles (2k+1)π/(n−m), centroid (Σp−Σz)/(n−m). Lead comp adds zero (speeds up); lag comp adds pole (reduces steady-state error).', key_takeaways: ['Root locus shows pole migration vs K', 'Lead compensation: add zero, improves transient', 'Lag compensation: add pole near origin, improves steady-state'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p6m5', title: 'Frequency Response: Bode, Nyquist, Margins', description: 'Bode (separate mag/phase vs freq). Nyquist (polar). Gain margin, phase margin. PM 30-60° typical.',
        duration_hours: 8, difficulty: 'Intermediate',
        lessons: [{ id: 'p6m5l1', title: 'Bode, Nyquist, gain and phase margin', type: 'reading', duration_min: 90, summary: 'GM=factor to multiply L before instability. PM=additional phase lag at gain crossover before instability. PM 30°→~20% OS, PM 60°→~8% OS, PM 90°→no OS. Bandwidth ≈ 1.8/t_r.', key_takeaways: ['PM is more useful than GM in practice', 'PM 30-60° is typical for well-designed loops', 'Bandwidth ≈ 1.8 / rise time'], has_playground: true }],
        projects: [], checkpoints: [],
      },
      { id: 'p6m6', title: 'PID Design and Tuning', description: 'P (fast, steady-state error), I (removes SS error, slows), D (damps, noise amplifier). Ziegler-Nichols tuning.',
        duration_hours: 8, difficulty: 'Intermediate',
        lessons: [{ id: 'p6m6l1', title: 'PID and Ziegler-Nichols tuning', type: 'reading', duration_min: 90, summary: 'C(s)=K_p·(1+1/(T_i·s)+T_d·s). ZN closed-loop: K_p=0.6K_u, T_i=0.5T_u, T_d=0.125T_u where K_u is ultimate gain, T_u is oscillation period. ZN is aggressive; detune by 50% for production.', key_takeaways: ['P: fast but steady-state error', 'I: removes SS error but reduces stability', 'D: damps but amplifies noise — usually filtered', 'ZN: aggressive tuning, detune for production'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p6m7', title: 'State-Space: Controllability and Observability', description: 'ẋ=Ax+Bu, y=Cx+D. Stable iff A eigenvalues in LHP. Controllable iff [B,AB,...,A^(n−1)B] full rank. LQR optimal control.',
        ...
        lessons: [{ id: 'p6m7l1', title: 'State-space, controllability, LQR', type: 'reading', duration_min: 90, summary: 'ẋ=Ax+Bu. Stable iff eig(A) in LHP. Controllable iff rank([B,AB,...,A^(n-1)B])=n. LQR minimizes J=∫(x^TQx+u^TRu)dt. Solve DARE for K. LQR has guaranteed 60° PM, 6dB GM.', key_takeaways: ['Stability: eig(A) real parts negative', 'Controllability: rank test on [B, AB, A²B, ...]', 'LQR: optimal state feedback, guaranteed margins'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p6m8', title: 'Digital Control: Sampled-Data Systems', description: 'Discretize continuous: A_d=e^(AT), B_d=∫₀ᵀ e^(Aτ)B dτ. ZOH on DAC. Sample at 10× closed-loop bandwidth.',
        duration_hours: 6, difficulty: 'Advanced',
        lessons: [{ id: 'p6m8l1', title: 'Discretization and ZOH', type: 'reading', duration_min: 60, summary: 'A_d=e^(AT), B_d=∫₀ᵀ e^(Aτ)B dτ. ZOH adds (1−e^(−sT))/s to plant. Sample rate 10× bandwidth; below 5× phase margin drops noticeably.', key_takeaways: ['A_d = e^(AT) (matrix exponential)', 'ZOH adds sinc-shaped response', 'Sample at 10× closed-loop bandwidth minimum'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p6m9', title: 'Robotics Kinematics', description: 'Forward: compose homogeneous transforms T_0_n=T_1·T_2·...·T_n. Inverse: analytic (simple), Jacobian pseudoinverse (general), optimization.',
        ...
        lessons: [{ id: 'p6m9l1', title: 'DH convention, forward and inverse kinematics', type: 'reading', duration_min: 90, summary: 'DH: each joint has T_i=Rot_z(θ_i)·Trans_z(d_i)·Trans_x(a_i)·Rot_x(α_i). Forward: multiply. Inverse: analytic for simple, Jacobian J^+·Δx for general, optimization for complex.', key_takeaways: ['Forward kinematics = matrix multiplication', 'Inverse kinematics: analytic (simple), Jacobian (general), optimization (complex)', 'Singularities: Jacobian loses rank, infinite solutions or none'] }],
        projects: [], checkpoints: [],
      },
...

  {
    ...
    modules: [
      { id: 'p7m1', title: 'Power Semiconductor Devices', description: 'Diode, MOSFET, IGBT, SCR, GaN, SiC. Switching loss, gate drive, bootstrap.',
        duration_hours: 6, difficulty: 'Intermediate',
        lessons: [{ id: 'p7m1l1', title: 'Power device landscape', type: 'reading', duration_min: 75, summary: 'Si MOSFET for <200V, IGBT for 600V-6.5kV motors, SiC for EVs and grid, GaN for high-freq DC-DC. Switching loss P_sw=½V·I·(t_r+t_f)·f_sw. Gate drivers provide 1-8A peak to charge gate quickly.', key_takeaways: ['MOSFET for low voltage, IGBT for high voltage', 'GaN and SiC are eating silicon for high efficiency', 'Gate driver provides high peak current for fast switching'] }],
        projects: [], checkpoints: [],
      },
      ...
      { id: 'p7m3', title: 'Isolated Converters: Flyback, Forward, Bridge', description: 'Flyback (<100W, cheap), Forward (<200W), Push-pull/Half-bridge (100-500W), Full-bridge (500W-5kW+), LLC resonant.',
        duration_hours: 7, difficulty: 'Intermediate',
        lessons: [{ id: 'p7m3l1', title: 'Isolated topologies and transformer design', type: 'reading', duration_min: 90, summary: 'Flyback: transformer as coupled inductor, energy stored in core. Forward: true transformer, energy passed directly. Full-bridge: 4 switches, for high power. LLC resonant: zero-voltage switching for high efficiency. Transformer design dominates: core, turns ratio, wire gauge, winding structure.', key_takeaways: ['Flyback is cheapest but limited to ~100W', 'Full-bridge for >500W', 'Transformer design is the hard part of isolated converters'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p7m4', title: 'Inverters: Square, PWM, SPWM, SVPWM', description: 'H-bridge. SPWM: sine ref vs triangle carrier. SVPWM: 15% more output voltage for 3-phase. Dead time.',
        duration_hours: 8, difficulty: 'Advanced',
        lessons: [{ id: 'p7m4l1', title: 'SPWM and SVPWM modulation', type: 'reading', duration_min: 90, summary: 'SPWM: compare sine ref to triangle carrier, duty follows sine. V_o_avg=m_a·V_dc·sin(ω_m·t). SVPWM: treat 3-phase as rotating space vector, time-average adjacent active vectors + zero. 15% more output than SPWM.', key_takeaways: ['SPWM duty cycle follows sine', 'SVPWM gives 15% more voltage for same DC bus', 'Dead time prevents cross-conduction in H-bridge'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p7m5', title: 'Rectifiers and Power Factor Correction', description: 'Bridge + cap input has PF 0.5-0.7. Boost PFC forces input current to follow |V_ac|. Mandatory >75W.',
        duration_hours: 6, difficulty: 'Intermediate',
        lessons: [{ id: 'p7m5l1', title: 'Boost PFC', type: 'reading', duration_min: 75, summary: 'Boost converter after bridge. Two loops: fast current loop makes I_L follow |V_ac|·sin(ωt), slow voltage loop regulates DC bus. Result: PF>0.99. Mandatory above 75W by IEC 61000-3-2.', key_takeaways: ['PFC makes load look resistive to line', 'Boost topology with two control loops', 'Mandatory above 75W'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p7m6', title: 'DC Machines', description: 'T=K·Φ·I_a, E=K·Φ·ω. PMDC, shunt, series, compound. Speed control: armature V, field Φ, R (wasteful).',
        duration_hours: 5, difficulty: 'Intermediate',
        lessons: [{ id: 'p7m6l1', title: 'DC motor types and speed control', type: 'reading', duration_min: 60, summary: 'T=K·Φ·I_a, E=K·Φ·ω. ω=(V−I_a·R_a)/(K·Φ). PMDC (magnets), shunt (independent field, self-regulating), series (high starting torque, traction), compound (compromise). PWM armature voltage is modern speed control.', key_takeaways: ['Back-EMF E=K·Φ·ω opposes applied voltage', 'Speed control via armature voltage (modern) or field weakening (high speed)', 'Series motor: high starting torque, used in traction'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p7m7', title: 'Induction Machines', description: 'n_s=120f/p. Slip s=(n_s−n)/n_s. Equivalent circuit. DOL/Star-delta/VFD starting. Torque-speed curve.',
        duration_hours: 7, difficulty: 'Advanced',
        lessons: [{ id: 'p7m7l1', title: 'Induction motor equivalent circuit', type: 'reading', duration_min: 90, summary: 'Rotating field at n_s=120f/p. Slip s=(n_s−n)/n_s. Per-phase equiv circuit: R_s, L_s, L_m, R_r, L_r, R_r·(1−s)/s (load). Torque-speed: starting, breakdown, synchronous.', key_takeaways: ['Synchronous speed n_s=120f/p', 'Slip is essential — without it, no torque', 'VFD starts at low f and V — gentlest method'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p7m8', title: 'Synchronous Machines and BLDC/PMSM', description: 'No slip. PMSM (sinusoidal BEMF) and BLDC (trapezoidal). Clarke+Park transforms. FOC.',
        duration_hours: 8, difficulty: 'Advanced',
        lessons: [{ id: 'p7m8l1', title: 'BLDC vs PMSM, Clarke+Park, FOC', type: 'reading', duration_min: 90, summary: 'BLDC: 6-step trapezoidal commutation with Hall sensors. PMSM: sinusoidal currents, FOC. Clarke: 3-phase to αβ. Park: αβ to dq rotating with rotor. i_d=flux (set to 0 for max torque/amp), i_q=torque. Two PI loops, inverse Park+Clarke, SVPWM.', key_takeaways: ['BLDC = 6-step trapezoidal, PMSM = sinusoidal FOC', 'Clarke+Park transforms to rotating dq frame aligned with rotor', 'FOC: i_d=0 (flux), i_q=torque — like DC motor control'], has_playground: true }],
        projects: [], checkpoints: [],
      },
      { id: 'p7m9', title: 'Motor Drives: V/f and FOC', description: 'V/f for induction (open-loop, 5% reg). FOC for induction and PMSM (closed-loop, 0.1% reg, 4-quadrant).',
        duration_hours: 6, difficulty: 'Advanced',
        lessons: [{ id: 'p7m9l1', title: 'V/f vs FOC drives', type: 'reading', duration_min: 60, summary: 'V/f: keep V/f constant, open-loop, simple, 5% reg. Suitable for fans/pumps. FOC: closed-loop, requires position sensor, 0.1% reg, 4-quadrant. Essential for servos and EVs. Sensorless FOC uses back-EMF or HF injection.', key_takeaways: ['V/f is open-loop, cheap, 5% regulation', 'FOC is closed-loop, expensive, 0.1% regulation', 'Sensorless FOC: estimate rotor position from electrical measurements'] }],
        projects: [], checkpoints: [],
      },
...

  {
    ...
    modules: [
      { id: 'p8m1', title: 'Vector Calculus for EM', description: 'Gradient ∇φ, divergence ∇·F, curl ∇×F. Divergence theorem, Stokes’ theorem. Three identities.',
        ...
        lessons: [{ id: 'p8m1l1', title: 'Three operators, three theorems', type: 'reading', duration_min: 75, summary: 'Gradient: scalar→vector (steepest ascent). Divergence: vector→scalar (source/sink). Curl: vector→vector (rotation). Divergence theorem: ∫∫∫∇·F dV=∮∮F·dA. Stokes: ∫∫(∇×F)·dA=∮F·dl.', key_takeaways: ['∇φ = gradient (steepest ascent direction)', '∇·F = divergence (positive at sources)', '∇×F = curl (measures rotation)', 'Divergence and Stokes theorems connect volume/surface/line integrals'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p8m2', title: 'Electrostatics: Gauss, Boundary Conditions', description: 'Gauss’s law for symmetric charge distributions. Capacitance. Dielectric boundary conditions.',
        duration_hours: 6, difficulty: 'Intermediate',
        lessons: [{ id: 'p8m2l1', title: 'Gauss’s law and capacitance', type: 'reading', duration_min: 75, summary: '∮E·dA=Q_enc/ε₀. Symmetric: point (E=kQ/r²), line (E=λ/(2πε₀r)), plane (E=σ/(2ε₀)). Capacitance C=Q/V: parallel plate εA/d, coax 2πε/ln(b/a). Boundary: tangential E continuous, normal D jumps by surface charge.', key_takeaways: ['Gauss’s law: pick symmetric Gaussian surface, integral becomes trivial', 'Dielectric multiplies ε by ε_r', 'Boundary conditions: tangential E continuous, normal D jumps'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p8m3', title: 'Magnetostatics: Biot-Savart, Ampère', description: 'Biot-Savart for arbitrary current distributions. Ampère for symmetric. Inductance L=λ/I. Magnetic energy W=½LI².',
        duration_hours: 6, difficulty: 'Intermediate',
        lessons: [{ id: 'p8m3l1', title: 'Biot-Savart and Ampère’s law', type: 'reading', duration_min: 75, summary: 'Biot-Savart: B=(μ₀/4π)·∫I·dl×r̂/r². Wire: B=μ₀I/(2πr). Solenoid: B=μ₀nI. Ampère: ∮B·dl=μ₀I_enc. Inductance L=λ/I. Energy W=½LI².', key_takeaways: ['Biot-Savart for arbitrary geometry', 'Ampère for symmetric (dual of Gauss)', 'Force between currents = electromechanical energy conversion'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p8m4', title: 'Maxwell’s Equations and EM Waves', description: 'Free space → wave equation ∇²E=μ₀ε₀·∂²E/∂t², v=1/√(μ₀ε₀)=c. E, B perpendicular to each other and propagation. Poynting vector.',
        duration_hours: 7, difficulty: 'Advanced',
        lessons: [{ id: 'p8m4l1', title: 'Wave equation, plane waves, spectrum', type: 'reading', duration_min: 90, summary: 'Free-space Maxwell → wave equation. v=c=3×10⁸ m/s. Plane wave E(z,t)=E₀cos(kz−ωt). Wave impedance η₀=√(μ₀/ε₀)≈377Ω. Poynting S=(1/μ₀)·E×B = power flow. EM spectrum: DC, audio, RF, microwave, IR, visible, UV, X-ray, gamma.', key_takeaways: ['Light is an EM wave at v=c', 'E and B perpendicular to each other and propagation', 'Wave impedance of free space ≈ 377Ω'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p8m5', title: 'Transmission Lines and the Smith Chart', description: 'Z₀=√(L/C), v_p=1/√(LC). Γ=(Z_L−Z₀)/(Z_L+Z₀). SWR. Smith chart for matching network design.',
        duration_hours: 8, difficulty: 'Advanced',
        lessons: [{ id: 'p8m5l1', title: 'Transmission lines and Smith chart', type: 'reading', duration_min: 90, summary: 'Any conductor pair with length ~λ is a transmission line. Z₀=√(L/C). v_p=1/√(LC)≈2c/3 for coax. Γ=(Z_L−Z₀)/(Z_L+Z₀). SWR=(1+|Γ|)/(1−|Γ|). Smith chart: polar Γ with constant-R and constant-X circles. Series L/C moves along constant-R; shunt along constant-G.', key_takeaways: ['Z₀=√(L/C) typically 50Ω for RF', 'Reflection coefficient Γ = (Z_L−Z₀)/(Z_L+Z₀)', 'Smith chart is graphical calculator for RF matching'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p8m6', title: 'Antennas: Dipole, Patch, Gain, Pattern', description: 'Half-wave dipole (2.15 dBi). Patch (6-9 dBi, narrowband). Friis: P_r=P_t·G_t·G_r·(λ/(4πR))².',
        duration_hours: 6, difficulty: 'Intermediate',
        lessons: [{ id: 'p8m6l1', title: 'Antenna parameters and Friis equation', type: 'reading', duration_min: 75, summary: 'Gain (dBi), pattern (polar plot), beamwidth, bandwidth, polarization, efficiency. Half-wave dipole: 2.15 dBi, 73Ω. Patch: 6-9 dBi, ~1% BW. Friis: P_r=P_t·G_t·G_r·(λ/(4πR))². Free-space loss at 2.4 GHz/100m ≈ −40 dB.', key_takeaways: ['Gain in dBi = dB relative to isotropic', 'Friis equation: P_r = P_t·G_t·G_r·(λ/(4πR))²', 'Patch is compact but narrowband (~1% BW)'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p8m7', title: 'RF Front-End: LNA, Mixer, Oscillator, PLL', description: 'Superheterodyne: antenna → LNA → mixer → IF filter → demod. Friis cascade: first stage dominates noise figure.',
        duration_hours: 7, difficulty: 'Advanced',
        lessons: [{ id: 'p8m7l1', title: 'Superheterodyne receiver and Friis cascade', type: 'reading', duration_min: 90, summary: 'LNA boosts weak signal with minimal added noise. Mixer multiplies RF by LO to shift to IF. PLL generates LO. Friis cascade: F=F_1+(F_2−1)/G_1+... — first stage dominates. Image frequency rejected by filter or I/Q mixing.', key_takeaways: ['Superheterodyne: antenna → LNA → mixer → IF → demod', 'First stage (LNA) dominates noise figure', 'Image rejection by filter or quadrature (I/Q) mixing'] }],
        projects: [], checkpoints: [],
      },
...

  {
    ...
    modules: [
      { id: 'p9m1', title: 'CMOS Inverter: Static and Dynamic', description: 'VTC, switching threshold, noise margins. t_p≈C_L·V_DD/(2·I_on). P=αCV²f dynamic + V_DD·I_leak static.',
        duration_hours: 7, difficulty: 'Intermediate',
        lessons: [{ id: 'p9m1l1', title: 'VTC and dynamic behavior', type: 'reading', duration_min: 90, summary: 'PMOS pull-up, NMOS pull-down. No DC current in either steady state — CMOS dominates. VTC has 5 regions; switching threshold V_M=V_DD/2 for symmetric. Noise margins NM_H=V_OH−V_IH, NM_L=V_IL−V_OL. t_p≈C_L·V_DD/(2·I_on). P_dyn=αCV²f, P_static=V_DD·I_leak.', key_takeaways: ['CMOS static power is essentially zero', 'Dynamic power P=αCV²f — voltage scaling is most powerful', 'Leakage dominates at advanced nodes (28nm and below)'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p9m2', title: 'CMOS Layout and Fabrication Flow', description: 'Layers: n-well, diffusion, poly, contacts, metal1-15. Design rules (min width/spacing/enclosure). 80 mask layers, 600-800 steps at 5nm.',
        duration_hours: 7, difficulty: 'Intermediate',
        lessons: [{ id: 'p9m2l1', title: 'Layout layers and fabrication flow', type: 'reading', duration_min: 90, summary: 'Layout = geometric description of every layer. Layers: n-well, p/n+ diffusion, poly (gate), contacts, metals. Design rules from foundry. Fab flow: substrate → photolithography → etch → implant → deposition → CMP → metal stack → passivation. Modern 5nm: ~80 masks, $15-20B fab.', key_takeaways: ['Layout describes every layer geometrically', 'Design rules ensure manufacturability', 'Modern fab: 80 mask layers, 600-800 steps, $15-20B fab cost'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p9m3', title: 'Combinational CMOS Design and Gate Sizing', description: 'Pull-up PMOS network, pull-down NMOS network — duals. NAND/NOR/AOI/OAI. Logical effort for sizing.',
        duration_hours: 6, difficulty: 'Intermediate',
        lessons: [{ id: 'p9m3l1', title: 'CMOS logic and logical effort', type: 'reading', duration_min: 75, summary: 'Pull-up PMOS and pull-down NMOS are duals: series in one ↔ parallel in other. NAND2: PMOS parallel, NMOS series. Logical effort g (1 for inverter, 4/3 for NAND2, 5/3 for NOR2). Optimal sizing equalizes stage effort g·h across chain.', key_takeaways: ['PMOS pull-up and NMOS pull-down are duals', 'Logical effort quantifies gate complexity', 'Optimal sizing: equal stage effort across chain'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p9m4', title: 'Sequential CMOS: Latches and Flip-Flops', description: 'Latch transparent when clock high/low. Master-slave D flop edge-triggered. t_su, t_h, t_cq. T_clk≥t_cq+t_pd,logic+t_su.',
        duration_hours: 5, difficulty: 'Intermediate',
        lessons: [{ id: 'p9m4l1', title: 'Latches, flip-flops, timing', type: 'reading', duration_min: 75, summary: 'Latch transparent during clock level. Master-slave D flop: two latches, edge-triggered. t_su: input stable before edge. t_h: stable after. t_cq: clock-to-Q delay. Min clock period: t_cq+t_pd,logic+t_su. Hold: t_cq+t_cd,logic≥t_h.', key_takeaways: ['D flop = two latches in master-slave', 'Setup/hold/clk-to-Q define timing', 'Min clock period = t_cq + logic delay + t_su'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p9m5', title: 'Static Timing Analysis', description: 'Setup: longest path (critical path). Hold: shortest path. PVT corners (SS/TT/FF). STA tools: PrimeTime, Tempus.',
        ...
        lessons: [{ id: 'p9m5l1', title: 'STA: setup, hold, corners', type: 'reading', duration_min: 90, summary: 'STA exhaustive — checks every path. Setup slack=T_clk−(t_cq+t_pd,logic+t_su)≥0. Hold slack=(t_cq+t_cd,logic)−t_h−skew≥0. PVT corners: SS at 0.9V/125°C (worst setup), FF at 1.1V/−40°C (worst hold). Sign off at all corners.', key_takeaways: ['STA checks every path, not just simulated ones', 'Setup = longest path; hold = shortest path', 'Must sign off at all PVT corners (SS, TT, FF)'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p9m6', title: 'Low-Power Design', description: 'Clock gating (-30 to -60% dynamic). Power gating (-90% leakage). DVFS. Substrate biasing.',
        ...
        lessons: [{ id: 'p9m6l1', title: 'Clock gating, power gating, DVFS', type: 'reading', duration_min: 75, summary: 'Clock gating: disable clock to idle blocks, cuts dynamic 30-60%. Power gating: cut V_DD to idle blocks, cuts leakage 90%+. DVFS: run slower at lower V. Substrate biasing: reverse body bias increases V_th, cuts leakage.', key_takeaways: ['Clock gating is the easiest big dynamic-power win', 'Power gating for leakage reduction in idle blocks', 'DVFS trades performance for power'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p9m7', title: 'ASIC vs FPGA Design Flow', description: 'ASIC: full flow, $1M-50M NRE, 8-24 week tape-out. FPGA: instant bitstream, $0 NRE, ~50-70% ASIC performance.',
        duration_hours: 5, difficulty: 'Intermediate',
        lessons: [{ id: 'p9m7l1', title: 'ASIC vs FPGA economics', type: 'reading', duration_min: 60, summary: 'Both: design entry → sim → synth → P&R → STA. ASIC adds DRC/LVS/ERC/antenna physical sign-off + tape-out to fab (8-24 weeks). FPGA: bitstream instant. ASIC unit cost low at volume; NRE $1M-50M. Rule: <100k units FPGA wins; >1M ASIC wins.', key_takeaways: ['ASIC: low unit cost, high NRE, slow iteration', 'FPGA: high unit cost, zero NRE, instant iteration', 'Volume threshold: ~100k-1M units for ASIC crossover'] }],
        projects: [], checkpoints: [],
      },
...

  {
    ...
    modules: [
      { id: 'p10m1', title: 'Power Generation', description: 'Thermal (coal/gas/nuclear), hydro, wind, solar. Capacity factor, LCOE. Renewables are intermittent.',
        duration_hours: 5, difficulty: 'Intermediate',
        lessons: [{ id: 'p10m1l1', title: 'Generation technologies and economics', type: 'reading', duration_min: 60, summary: 'Thermal plants boil water → steam turbine → synchronous generator. Hydro uses falling water. Gas turbines use combustion gases directly. Wind uses aerodynamic lift. Solar PV uses photovoltaic effect. Capacity factor: nuclear 90%, solar 20%, wind 35%. LCOE: solar/wind cheapest now.', key_takeaways: ['Capacity factor = actual output / rated output', 'Nuclear has highest capacity factor (90%)', 'Solar/wind are intermittent — need storage or backup'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p10m2', title: 'Transmission and Distribution', description: 'Voltage hierarchy: 200-1000kV transmission, 50-100kV subtransmission, 10-30kV primary, 120/230V secondary. P_loss=I²R scales as 1/V².',
        duration_hours: 5, difficulty: 'Intermediate',
        lessons: [{ id: 'p10m2l1', title: 'Why high voltage for transmission', type: 'reading', duration_min: 60, summary: 'P_loss=I²R. For fixed P=VI, I~1/V, so P_loss~1/V². Doubling V reduces losses 4×. HVDC for >600km: no skin effect, no reactive loss. China has 3000km, 1.1MV HVDC link.', key_takeaways: ['Transmission at high V to minimize I²R loss', 'HVDC beats AC above ~600 km', 'Voltage hierarchy: transmission → subtransmission → primary → secondary distribution'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p10m3', title: 'Power System Protection', description: 'CT/VT step down for measurement. Relays decide. Breakers interrupt. Overcurrent (50/51), differential (87), distance (81).',
        duration_hours: 6, difficulty: 'Intermediate',
        lessons: [{ id: 'p10m3l1', title: 'Protection principles and schemes', type: 'reading', duration_min: 75, summary: 'CT and VT step down current/voltage. Numerical relays decide trip. Breakers interrupt fault. Selectivity: only closest breaker trips. Speed: 3-5 cycles (60-100 ms). Schemes: overcurrent (50/51), differential (87) for transformers/buses, distance (21) for lines, under/over-frequency (81).', key_takeaways: ['Selectivity: only closest breaker trips', 'Speed: 3-5 cycles to limit damage', 'Differential protection: trip if current in ≠ current out'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p10m4', title: 'Power Quality and Grid Stability', description: 'Sags, swells, harmonics, flicker, transients, freq deviations. Rotor angle / frequency / voltage stability.',
        duration_hours: 5, difficulty: 'Intermediate',
        lessons: [{ id: 'p10m4l1', title: 'Power quality and three stability timescales', type: 'reading', duration_min: 75, summary: 'PQ problems: voltage sags/swells, harmonics (from nonlinear loads), flicker (arc furnaces), transients (lightning). Stability: rotor angle (seconds — synchronism), frequency (seconds-minutes — load/gen balance), voltage (minutes — reactive power balance).', key_takeaways: ['Power quality = deviation from ideal 50/60 Hz pure sine', 'Three stability timescales: rotor angle, frequency, voltage', 'Reactive power balance sets voltage stability'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p10m5', title: 'Smart Grid, Microgrids, DER Integration', description: 'Bidirectional comm, distributed sensing. Microgrids can island. DER challenges: variability, voltage regulation, protection, inverter coordination.',
        duration_hours: 5, difficulty: 'Intermediate',
        lessons: [{ id: 'p10m5l1', title: 'Smart grid and DER integration', type: 'reading', duration_min: 75, summary: 'Smart grid adds bidirectional comm, sensing, automated control. Microgrid = local grid that can island. DER challenges: variability (clouds), voltage regulation (PV raises local V), protection (bidirectional faults), inverter coordination (ride-through).', key_takeaways: ['Smart grid = traditional grid + bidirectional comm + automation', 'Microgrid can island from main grid', 'High-penetration DER breaks traditional radial protection'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p10m6', title: 'Energy Storage and Battery Management', description: 'Li-ion for <4h, pumped hydro for daily/weekly, flow batteries for utility. BMS monitors cells, balances, protects. SOC/SOH.',
        duration_hours: 6, difficulty: 'Intermediate',
        lessons: [{ id: 'p10m6l1', title: 'Storage technologies and BMS', type: 'reading', duration_min: 75, summary: 'Li-ion dominates <4h. Pumped hydro for daily/weekly. Flow batteries and CAES for utility long-duration. BMS monitors cell V, T, I; balances cells; protects against over-charge/discharge/T. SOC by coulomb counting or EKF. SOH tracks capacity fade and R growth.', key_takeaways: ['Li-ion for short duration, pumped hydro for long', 'BMS is mandatory for Li-ion safety', 'SOC by coulomb counting (drifts) or EKF (accurate)'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p10m7', title: 'Solar PV Systems and MPPT', description: 'PV cell = illuminated diode. MPP moves with irradiance and temp. P&O MPPT = hill climbing. String vs microinverter.',
        ...
        lessons: [{ id: 'p10m7l1', title: 'PV model and MPPT algorithms', type: 'reading', duration_min: 90, summary: 'PV cell = illuminated diode. I-V curve has knee at MPP. MPP V moves with irradiance and temp. P&O: perturb V, observe P, reverse if decreased. Incremental conductance: dP/dV sign. String inverter (cheap, single point of failure), microinverter (panel-level MPPT), optimizer+string.', key_takeaways: ['PV cell = illuminated diode', 'MPP moves with irradiance and temperature', 'P&O MPPT = hill climbing on P-V curve'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p10m8', title: 'Wind Energy Systems', description: 'Power=½ρAv³C_p. Betz limit 0.593. Fixed-speed induction, variable-speed DFIG, variable-speed PMSG with full converter.',
        ...
        lessons: [{ id: 'p10m8l1', title: 'Wind turbine types', type: 'reading', duration_min: 60, summary: 'Power=½ρAv³C_p. Betz limit 0.593. v³ dependence → 10% speed increase = 33% more power. Three types: fixed-speed induction (legacy), DFIG (partial converter, ~30% of fleet), PMSG with full converter (best energy capture, ~70% of new).', key_takeaways: ['Wind power scales as v³ — very sensitive to wind speed', 'Betz limit: max 59.3% of kinetic energy extractable', 'Modern turbines: PMSG with full converter for variable speed'] }],
        projects: [], checkpoints: [],
      },
      { id: 'p10m9', title: 'EV Charging Infrastructure', description: 'L1 (1.4 kW), L2 (7-22 kW), DCFC (50-350 kW). Connectors: CCS, NACS, CHAdeMO. Grid impact of fast charging. V2G.',
        duration_hours: 4, difficulty: 'Intermediate',
        lessons: [{ id: 'p10m9l1', title: 'EV charging levels and standards', type: 'reading', duration_min: 60, summary: 'L1: 120/230V AC, ~1.4 kW (overnight home). L2: 240/400V AC, 7-22 kW (home/workplace). DCFC: 50-350 kW DC, 80% in 20-40 min. Connectors: SAE J1772 (L1/L2), CCS (DC fast), NACS (Tesla/SAE J3400 — new US standard), CHAdeMO (legacy Japanese). V2G: EV batteries as grid storage.', key_takeaways: ['Three charging levels: L1, L2, DCFC', 'NACS (Tesla) becoming US standard as SAE J3400', '350 kW fast charger = small neighborhood load — grid impact matters'] }],
        projects: [], checkpoints: [],
      },
